'''
@Author: David Vu
Run the pretrained model to extract 128D face features,InceptionResnetV1/Bottleneck/BatchNorm/batchnorm/add_1
'''
...
class FaceFeature(object):
    def __init__(self, face_rec_graph, model_path = '/home/sigsenz/Documents/FaceRec-master_new_FR/models/20170512-110547.pb'):
        '''
